...
export function LowMatchBanner({
  ...
  return (
    <div
      role="alert"
      className="mb-6 rounded-xl border border-[var(--destructive)]/30 bg-[var(--destructive)]/5 p-4 flex items-start gap-3"
    >
      <AlertTriangle
        size={18}
        className="text-[var(--destructive)] mt-0.5 shrink-0"
      />
