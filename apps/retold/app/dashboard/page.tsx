...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-3xl space-y-8">
          ...
          <Card className="hover:border-accent/50 transition-colors cursor-pointer">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted">Base Resumes</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="hover:border-accent/50 transition-colors cursor-pointer">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted">Tailored Versions</p>
              </div>
            </CardContent>
          </Card>
        </Link>
              ...
              <CardContent className="p-5 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2 mt-1">
                    <p className="text-xs text-muted">Runs left this month</p>
                  </div>
      ...
      <div>
        <p className="text-sm text-muted mb-3">Quick actions</p>
